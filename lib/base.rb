...
class HuboardApplication < Sinatra::Base
  ...
  ENV['GITHUB_OAUTH_DOMAIN'] = 'https://wagit/api/v3/'
  ENV['OCTOKIT_API_ENDPOINT'] = 'https://wagit/api/v3/'
  ENV['OCTOKIT_WEB_ENDPOINT'] = 'https://wagit/'
  ENV['GITHUB_OAUTH_API_DOMAIN'] = 'https://wagit/api/v3/'
